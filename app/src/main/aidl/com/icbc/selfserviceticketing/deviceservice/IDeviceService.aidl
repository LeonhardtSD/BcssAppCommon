...
import com.icbc.selfserviceticketing.deviceservice.IElectronicScale;
...
interface IDeviceService {
    ...
    *
    * 闸机设备
    * @return IGateOperator   获取闸机设备对象，详见IGateOperator.aidl定义
    */
    ...
    */
    ...
    /**
      *
      * 电子称操作
      * @return IElectronicScale   获取设备电子称操作对象，详见IElectronicScale.aidl定义
      */
     IElectronicScale getElectronicScale();
}
